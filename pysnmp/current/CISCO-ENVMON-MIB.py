...
# by libsmi2pysnmp-0.1.3 at Mon Nov 18 22:11:11 2013,
...
ciscoEnvMonMIB = ModuleIdentity((1, 3, 6, 1, 4, 1, 9, 9, 13)).setRevisions(("2003-12-01 00:00","2003-11-25 00:00","2002-10-15 00:00","2002-07-17 00:00","2002-02-04 00:00","2001-08-30 00:00","2001-08-16 00:00","2001-05-07 00:00","2000-01-31 00:00","1998-10-22 00:00","1998-08-05 00:00","1996-11-12 00:00","1995-08-15 00:00","1995-03-13 00:00",))
...
ciscoEnvMonPresent = MibScalar((1, 3, 6, 1, 4, 1, 9, 9, 13, 1, 1), Integer().subtype(subtypeSpec=SingleValueConstraint(4,13,9,8,6,10,3,1,12,7,14,11,2,)).subtype(namedValues=NamedValues(("oldAgs", 1), ("c10000", 10), ("osr7600", 11), ("c7600", 12), ("c37xx", 13), ("other", 14), ("ags", 2), ("c7000", 3), ("ci", 4), ("cAccessMon", 6), ("cat6000", 7), ("ubr7200", 8), ("cat4000", 9), ))).setMaxAccess("readonly")
