...
# ASN.1 source file:///opt/xee/dev/mibs/asn1/ietf/P-BRIDGE-MIB
...
( dot1dTpPort, dot1dBridge, dot1dTp, dot1dBasePortEntry, dot1dBasePort, ) = mibBuilder.importSymbols("BRIDGE-MIB", "dot1dTpPort", "dot1dBridge", "dot1dTp", "dot1dBasePortEntry", "dot1dBasePort")
...
( TruthValue, TimeInterval, DisplayString, TextualConvention, MacAddress, ) = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeInterval", "DisplayString", "TextualConvention", "MacAddress")
...
mibBuilder.exportSymbols("P-BRIDGE-MIB", dot1dTpHCPortEntry=dot1dTpHCPortEntry, dot1dPortCapabilitiesTable=dot1dPortCapabilitiesTable, pBridgePortGmrpGroup=pBridgePortGmrpGroup, dot1dPortGmrpFailedRegistrations=dot1dPortGmrpFailedRegistrations, dot1dUserPriorityRegenEntry=dot1dUserPriorityRegenEntry, dot1dDeviceCapabilities=dot1dDeviceCapabilities, dot1dPortCapabilitiesEntry=dot1dPortCapabilitiesEntry, EnabledStatus=EnabledStatus, dot1dPortGarpJoinTime=dot1dPortGarpJoinTime, pBridgeMIBObjects=pBridgeMIBObjects, dot1dPortGarpTable=dot1dPortGarpTable, dot1dPortOutboundAccessPriorityEntry=dot1dPortOutboundAccessPriorityEntry, dot1dPortNumTrafficClasses=dot1dPortNumTrafficClasses, dot1dTrafficClassPriority=dot1dTrafficClassPriority, dot1dTpPortOverflowTable=dot1dTpPortOverflowTable, dot1dPortGmrpLastPduOrigin=dot1dPortGmrpLastPduOrigin, pBridgePriorityGroup=pBridgePriorityGroup, dot1dTrafficClassEntry=dot1dTrafficClassEntry, dot1dTpHCPortInDiscards=dot1dTpHCPortInDiscards, dot1dPortOutboundAccessPriorityTable=dot1dPortOutboundAccessPriorityTable, pBridgePortOverflowGroup=pBridgePortOverflowGroup, pBridgeExtCapGroup=pBridgeExtCapGroup, dot1dExtBase=dot1dExtBase, dot1dPortGarpLeaveAllTime=dot1dPortGarpLeaveAllTime, pBridgeCompliances=pBridgeCompliances, dot1dTpPortOverflowEntry=dot1dTpPortOverflowEntry, pBridgePortGmrpGroup2=pBridgePortGmrpGroup2, pBridgeCompliance=pBridgeCompliance, dot1dTpPortOutOverflowFrames=dot1dTpPortOutOverflowFrames, pBridgeDevicePriorityGroup=pBridgeDevicePriorityGroup, pBridgeDefaultPriorityGroup=pBridgeDefaultPriorityGroup, dot1dTpPortInOverflowFrames=dot1dTpPortInOverflowFrames, dot1dGarp=dot1dGarp, pBridgeHCPortGroup=pBridgeHCPortGroup, dot1dPortGmrpEntry=dot1dPortGmrpEntry, PYSNMP_MODULE_ID=pBridgeMIB, dot1dPortRestrictedGroupRegistration=dot1dPortRestrictedGroupRegistration, dot1dGmrp=dot1dGmrp, dot1dRegenUserPriority=dot1dRegenUserPriority, dot1dPortPriorityEntry=dot1dPortPriorityEntry, pBridgeCompliance2=pBridgeCompliance2, dot1dPortDefaultUserPriority=dot1dPortDefaultUserPriority, dot1dTpHCPortOutFrames=dot1dTpHCPortOutFrames, dot1dUserPriority=dot1dUserPriority, dot1dPortGmrpTable=dot1dPortGmrpTable, dot1dPortGarpEntry=dot1dPortGarpEntry, dot1dTrafficClassTable=dot1dTrafficClassTable, dot1dPortOutboundAccessPriority=dot1dPortOutboundAccessPriority, dot1dTpPortInOverflowDiscards=dot1dTpPortInOverflowDiscards, pBridgeConformance=pBridgeConformance, dot1dGmrpStatus=dot1dGmrpStatus, dot1dTrafficClassesEnabled=dot1dTrafficClassesEnabled, pBridgeGroups=pBridgeGroups, dot1dTrafficClass=dot1dTrafficClass, dot1dPortCapabilities=dot1dPortCapabilities, pBridgeMIB=pBridgeMIB, dot1dUserPriorityRegenTable=dot1dUserPriorityRegenTable, dot1dTpHCPortInFrames=dot1dTpHCPortInFrames, dot1dPortGarpLeaveTime=dot1dPortGarpLeaveTime, pBridgeRegenPriorityGroup=pBridgeRegenPriorityGroup, dot1dPortPriorityTable=dot1dPortPriorityTable, dot1dPortGmrpStatus=dot1dPortGmrpStatus, pBridgeAccessPriorityGroup=pBridgeAccessPriorityGroup, pBridgePortGarpGroup=pBridgePortGarpGroup, pBridgeDeviceGmrpGroup=pBridgeDeviceGmrpGroup, dot1dPriority=dot1dPriority, dot1dTpHCPortTable=dot1dTpHCPortTable)
